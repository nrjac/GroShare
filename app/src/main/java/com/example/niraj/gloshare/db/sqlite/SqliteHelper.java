package com.example.niraj.gloshare.db.sqlite;

/**
 * Created by Niraj on 9/15/2017.
 */
...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_NAME, user.getName()); // User Name
        values.put(COLUMN_EMAIL, user.getEmail()); // User Email
    ...
    User getUser(int id) {
        ...
        Cursor cursor = db.query(TABLE_USERS, new String[] { COLUMN_ID,
                        COLUMN_NAME, COLUMN_EMAIL }, COLUMN_ID + "=?",
